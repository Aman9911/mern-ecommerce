...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    user: "aman.vdpl@gmail.com", // Gmail id
...
exports.sendMail = async function ({ to, subject, text, html }) {
  ...
  const info = await transporter.sendMail({
    from: '"ESHOP WELL" <aman.vdpl@gmail.com>', // sender address
...
<body style="background-color: #D2C7BA;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://mern-ecommerce-livid.vercel.app/" target="_blank" style="display: inline-block;">
                <img src="https://i.ibb.co/JRvyJPY/ecommerce.png" alt="Logo" border="0" width="250" style="display: block; width: 250px; max-width: 250px; min-width: 250px;">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="aman.vdpl@gmail.com">contact us</a>.<br>Your order Id is <strong>${
                order.id
              }</strong>.</p>
            </td>
          </tr>
  ...
  }, ${order.selectedAddress.city}<br>${order.selectedAddress.state} - ${
